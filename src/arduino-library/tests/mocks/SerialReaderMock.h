 ...
 * @brief Mock definition of the mididmxbridge::ISerialReader interface
 * @version 1.0
 * @date 2024-01-04
 *
...
/**
 * @brief This class provides the mock implementation of the mididmxbridge::ISerialReader interface.
 *
 */
class SerialReaderMock : public mididmxbridge::ISerialReader {
 public:
  /**
  ...
  /**
   * @brief Mock methods from mididmxbridge::ISerialReader.
   *
   */
  ///@{
